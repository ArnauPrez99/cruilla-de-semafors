...
void loop()
{
  ...
  digitalWrite(led1, LOW);    // posar a 5V el pin 8
  digitalWrite(led2, LOW);    // posar a 5V el pin 9
  digitalWrite(led3, LOW);    // posar a 5V el pin 10
  digitalWrite(led4, LOW);    // posar a 5V el pin 11
  ...
  digitalWrite(led3, HIGH);     // posar a 0V el pin 10
  digitalWrite(led4, LOW);     // posar a 0V el pin 11
  ...
  digitalWrite(led1, LOW);     // posar a 0V el pin 8
  digitalWrite(led2, LOW);     // posar a 0V el pin 9
  digitalWrite(led3, LOW);     // posar a 0V el pin 10
  digitalWrite(led4, HIGH);     // posar a 0V el pin 11
  digitalWrite(led5, LOW);     // posar a 0V el pin 12
  ...
  digitalWrite(led1, LOW);    // posar a 5V el pin 8
  digitalWrite(led2, HIGH);    // posar a 5V el pin 9
  digitalWrite(led3, LOW);    // posar a 5V el pin 10
  digitalWrite(led4, LOW);    // posar a 5V el pin 11
  digitalWrite(led5, HIGH);    // posar a 5V el pin 12
